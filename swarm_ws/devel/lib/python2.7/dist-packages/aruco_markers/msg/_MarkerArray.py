...
"""autogenerated by genpy from aruco_markers/MarkerArray.msg. Do not edit."""
import sys
...
import aruco_markers.msg
import std_msgs.msg

class MarkerArray(genpy.Message):
  _md5sum = "c83561ca1ae4ac98039651009b8168f1"
  _type = "aruco_markers/MarkerArray"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """aruco_markers/Marker[] markers
...
float64 theta"""
  __slots__ = ['markers']
  _slot_types = ['aruco_markers/Marker[]']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.markers:
        ...
        _x = _v5
        buff.write(_get_struct_3d().pack(_x.x, _x.y, _x.z))
        length = len(val1.pixel_corners)
        buff.write(_struct_I.pack(length))
        for val2 in val1.pixel_corners:
          _x = val2
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          val1.pixel_corners.append(val2)
