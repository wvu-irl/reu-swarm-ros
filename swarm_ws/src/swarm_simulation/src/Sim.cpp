			...
			if (msg.commands.at(j).rid == flock.flock.at(i).numid)
			{
				...
				if (0 <= theta && theta < M_PI_2 || theta > 3 * M_PI_2)
				{
					if (theta < M_PI)
					{
						...
						if (abs(flock.flock.at(i).a)>speed)	flock.flock.at(i).a=flock.flock.at(i).a>0.0 ? speed: -speed;
					...
					} else
					{
						...
						if (abs(flock.flock.at(i).b)>speed)	flock.flock.at(i).b=flock.flock.at(i).b>0.0 ? speed: -speed;
					}
				}
